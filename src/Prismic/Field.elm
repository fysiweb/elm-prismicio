module Prismic.Field exposing
    ...
    , Date, Timestamp
    , Color, GeoPoint, Select
    , text, structuredText, image, date, link, timestamp, color, geoPoint, select
...
@docs Color, GeoPoint, Select


## Decoding fields

@docs text, structuredText, image, date, link, timestamp, color, geoPoint, select
    ...
    Decoder
        (\field ->
            case field of
                ...
                _ ->
                    Err "Expected a Text field, but got ''."
        )
    ...
    Decoder
        (\field ->
            case field of
                ...
                _ ->
                    Err "Expected a StructuredText field, but got ''."
        )
    ...
    Decoder
        (\field ->
            case field of
                ...
                _ ->
                    Err "Expected an Select field, but got ''."
        )
    ...
    Decoder
        (\field ->
            case field of
                ...
                _ ->
                    Err "Expected a Link field, but got ''."
        )
